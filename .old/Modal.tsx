...
import { Box, Button, Typography, Modal, FormControl, InputLabel, Select, MenuItem, SelectChangeEvent, TextField } from '@mui/material';

import AddIcon from '@mui/icons-material/Add';
import { Ingredient, IngredientCategory, ingredientCategoryArray } from '../src/types/ingredient';
import { postIngredient } from '../src/api/Post';
