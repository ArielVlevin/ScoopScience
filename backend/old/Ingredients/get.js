import { getDataByID, getLastInsertedID } from "../crud.js";
import { Ingredient } from "../../src/models/Ingredient.js";

export default async function getIngredients(app) {
  app.get("/api/get/ingredient/:id", async (req, res) => {
  ...
  app.get("/api/get/ingredients/lastid/:category", async (req, res) => {
  ...
  app.get("/api/get/ingredients/ingredientsArray", async (req, res) => {
    try {
  ...
  app.get("/api/get/ingredients/ingredientsArray/:recipe", async (req, res) => {
