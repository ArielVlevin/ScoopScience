...
export default function MainControl() {
  ...
  return (
    <div
      ref={containerRef}
      className="container h-64 min-h-64 flex flex-col p-2"
    >
      <Title>Recipes</Title>
      <Separator className="my-4" />
      <div className="flex-1 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="transition-all duration-300 " data-swapy-slot="slot1">
          <Card className="flex-1 h-24" data-swapy-item="a">
            <CardHeader>
        ...
        <div
          className="transition-all duration-300 h-max"
          data-swapy-slot="slot2"
        >
          <Card className="flex-1 h-max-20  " data-swapy-item="b">
            <CardHeader>
        ...
        <div className=" transition-all duration-300" data-swapy-slot="slot3">
        ...
        <div className="transition-all duration-300" data-swapy-slot="slot4">
        ...
        <div className="transition-all duration-300" data-swapy-slot="slot5">
        ...
        <div className="transition-all duration-300" data-swapy-slot="slot6">
