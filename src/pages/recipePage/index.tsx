...
/**
* v0 by Vercel.
* @see https://v0.dev/t/H29SYnAmO8P
     ...
     <div className="grid gap-8 md:grid-cols-2">
       ...
       <div>
         ...
         <p className="text-muted-foreground mb-6">
           This classic vanilla ice cream is rich, creamy, and perfect for any occasion. Made with just a few simple
           ingredients, it's a delicious treat that the whole family will love.
         </p>
           ...
           <ol className="space-y-4">
             <li>
               ...
               <p className="text-muted-foreground">
                 In a medium saucepan, combine the heavy cream, milk, sugar, and salt. Heat the mixture over medium
                 heat, stirring occasionally, until the sugar has dissolved and the mixture is hot but not boiling.
               </p>
             </li>
             <li>
               <h3 className="font-medium mb-2">Chill the Base</h3>
               <p className="text-muted-foreground">
                 Remove the saucepan from the heat and stir in the vanilla extract. Pour the mixture into a clean bowl
                 and refrigerate for at least 2 hours, or until completely chilled.
               </p>
             </li>
             <li>
               <h3 className="font-medium mb-2">Churn the Ice Cream</h3>
               <p className="text-muted-foreground">
                 Once the base is chilled, pour it into an ice cream maker and churn according to the manufacturer's
             ...
             <li>
               ...
               <p className="text-muted-foreground">
                 Transfer the churned ice cream to a freezer-safe container and freeze for at least 2 hours before
                 serving. Scoop and enjoy!
               </p>
             </li>
           </ol>
         </div>
