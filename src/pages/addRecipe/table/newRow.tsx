...
function handleSaveNewRow  (rows: Row[] | null, setRows: React.Dispatch<React.SetStateAction<Row[]>>, setIsAddingIngredient: React.Dispatch<React.SetStateAction<boolean>>, ingredientData: Ingredient | null, weight: number)  {
...
export default function AddRow({rows, setRows, isAddingIngredient, setIsAddingIngredient} : AddRowProps) {
              ...
              <Popover open={isAddingIngredient} onOpenChange={setIsAddingIngredient} >
                ...
                <div className="grid gap-2">
                  ...
                  <div className="flex justify-end gap-4 mt-4 ">
                    ...
                    <Button onClick={() => handleSaveNewRow(rows, setRows, setIsAddingIngredient, ingredient, weight) }>Add</Button>
                  </div>
                  </div>
                  )}
