...
export declare const renderContinuousColorLegendToCanvas: (ctx: CanvasRenderingContext2D, { containerWidth, containerHeight, anchor, translateX, translateY, scale, length, thickness, direction, ticks: _ticks, tickPosition, tickSize, tickSpacing, tickOverlap, tickFormat, title, titleAlign, titleOffset, theme, }: import("./typesndProps & {
    anchor: import("./types
