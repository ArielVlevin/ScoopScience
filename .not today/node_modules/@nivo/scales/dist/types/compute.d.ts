...
export declare function computeScale<Input extends ScaleValue>(spec: ScaleSpec, data: ComputedSerieAxis<any>, size: number, axis: ScaleAxis): import("./types./types").ScaleSymlog ./typesar<number> | import("./ty./typesort("./types").ScaleBand<Input> |./typesDate | import("d3-scale").Numbe./types./types
/**
...
export declare const computeXYScalesForSeries: <S = never, D extends SerieDatum = SerieDatum>(series: Serie<S, D>[], xScaleSpec: ScaleSpec, yScaleSpec: ScaleSpec, width: number, height: number) => {
    ...
    xScale: import("./types./types").ScaleSymlog ./typesar<number> | import("./ty./types("d3-scale").NumberValue> | impor./types]> | import("./types").ScaleBand<D["x"]>;./types./types
    yScale: import("./types./types").ScaleSymlog ./typesar<number> | import("./ty./types("d3-scale").NumberValue> | impor./types]> | import("./types").ScaleBand<D["y"]>;./types./types
    x: {
        all: unknown[];
        min: unknown;
        max: unknown;
