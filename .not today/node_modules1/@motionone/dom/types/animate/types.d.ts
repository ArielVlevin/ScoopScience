...
import { ValueKeyframe } from "../../../types/types";
...
export declare type AnimationOptionsWithOverrides = StyleAnimationOptions &
  VariableAnimationOptions &
  AnimationOptions;
export declare type ValueKeyframesDefinition =
  | ValueKeyframe
  | ValueKeyframe[]
  | UnresolvedValueKeyframe[];
...
export declare type MotionKeyframesDefinition = StyleKeyframesDefinition &
  VariableKeyframesDefinition;
export interface AnimationWithCommitStyles extends Animation {
  commitStyles: VoidFunction;
}
export declare type AnimationListOptions = Omit<
