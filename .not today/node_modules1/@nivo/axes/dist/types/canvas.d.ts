import { CompleteTheme } from "../../../core";
import { ScaleValue, AnyScale, TicksSpec } from "../../../scales/dist/types";
import {
  AxisLegendPosition,
  CanvasAxisProps,
  ValueFormatter,
} from "node_modules1/@nivo/axes/src/types";
export declare const renderAxisToCanvas: <Value extends ScaleValue>(
...
export declare const renderAxesToCanvas: <
  X extends ScaleValue,
  Y extends ScaleValue
>(
  ctx: CanvasRenderingContext2D,
  {
    xScale,
...
export declare const renderGridLinesToCanvas: <Value extends ScaleValue>(
  ctx: CanvasRenderingContext2D,
  {
    width,
    height,
