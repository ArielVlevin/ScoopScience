...
export declare const computeDimensions: ({
  direction,
  itemsSpacing,
  padding: _padding,
  itemCount,
  ...
  Record<
    "itemsSpacing" | "itemCount" | "itemWidth" | "itemHeight",
    number
  >) => {
  width: number;
  height: number;
...
export declare const computePositionFromAnchor: ({
  anchor,
  translateX,
  translateY,
  containerWidth,
...
export declare const computeItemLayout: ({
  direction,
  justify,
  symbolSize,
  symbolSpacing,
...
export declare const computeContinuousColorsLegend: ({
  scale,
  ticks,
  length,
  thickness,
