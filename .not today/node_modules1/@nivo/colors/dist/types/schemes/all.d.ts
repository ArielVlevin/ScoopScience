import { CategoricalColorSchemeId } from "node_modules1/@nivo/colors/src/schemes/categorical";
import { DivergingColorSchemeId } from "node_modules1/@nivo/colors/src/schemes/diverging";
import { SequentialColorSchemeId } from "node_modules1/@nivo/colors/src/schemes/sequential";
...
export declare const isCategoricalColorScheme: (
  ...
  | "set3"
  | "tableau10";
export declare const isDivergingColorScheme: (
  scheme: ColorSchemeId
) => scheme is
  | "brown_blueGreen"
  | "purpleRed_green"
  ...
  | "red_yellow_green"
  | "spectral";
export declare const isSequentialColorScheme: (
  scheme: ColorSchemeId
) => scheme is
  | "blues"
  | "greens"
