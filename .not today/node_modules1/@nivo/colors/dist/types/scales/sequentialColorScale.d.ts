...
export interface SequentialColorScaleSchemeConfig
  extends SequentialColorScaleBaseConfig {
  scheme?: ColorInterpolatorId;
}
export interface SequentialColorScaleColorsConfig
  extends SequentialColorScaleBaseConfig {
  colors: [string, string];
}
export interface SequentialColorScaleInterpolatorConfig
  extends SequentialColorScaleBaseConfig {
...
export declare const getSequentialColorScale: (
  config: SequentialColorScaleConfig,
  values: SequentialColorScaleValues
) => import("../../../../../@types/d3-scale").ScaleSequential<string, never>;
export declare const useSequentialColorScale: (
  config: SequentialColorScaleConfig,
  values: SequentialColorScaleValues
) => import("../../../../../@types/d3-scale").ScaleSequential<string, never>;
