...
export interface DivergingColorScaleSchemeConfig
  extends DivergingColorScaleBaseConfig {
  scheme?: ColorInterpolatorId;
}
export interface DivergingColorScaleColorsConfig
  extends DivergingColorScaleBaseConfig {
  colors: [string, string, string];
}
export interface DivergingColorScaleInterpolatorConfig
  extends DivergingColorScaleBaseConfig {
...
export declare const getDivergingColorScale: (
  config: DivergingColorScaleConfig,
  values: DivergingColorScaleValues
) => import("../../../../../@types/d3-scale").ScaleDiverging<string, never>;
export declare const useDivergingColorScale: (
  config: DivergingColorScaleConfig,
  values: DivergingColorScaleValues
) => import("../../../../../@types/d3-scale").ScaleDiverging<string, never>;
export {};
