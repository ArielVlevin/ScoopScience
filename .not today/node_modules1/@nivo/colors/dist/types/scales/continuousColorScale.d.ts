...
export type ContinuousColorScaleValues =
  ...
  | DivergingColorScaleValues
  | QuantizeColorScaleValues;
export declare const getContinuousColorScale: <
  Config extends ContinuousColorScaleConfig
>(
  config: Config,
...
export declare const useContinuousColorScale: (
  ...
  | ScaleDiverging<string, never>
  | ScaleQuantize<string, never>;
export declare const computeContinuousColorScaleColorStops: (
  scale:
