 ...
 */
export declare const getOrdinalColorScale: <Datum = any>(
  config: OrdinalColorScaleConfig<Datum>,
  identity?: string | DatumIdentityAccessor<Datum> | undefined
) => OrdinalColorScale<Datum>;
export declare const useOrdinalColorScale: <Datum = any>(
  config: OrdinalColorScaleConfig<Datum>,
