...
export declare const compareValues: (
  a: string | number,
  b: string | number
) => boolean;
export declare const compareDateValues: (a: Date, b: Date) => boolean;
export declare function computeScale<Input extends ScaleValue>(
  spec: ScaleSpec,
  data: ComputedSerieAxis<any>,
  size: number,
  axis: ScaleAxis
):
  | import("./types").ScaleLog
  | import("./types").ScaleSymlog
  | import("./types").ScaleLinear<number>
  | import("./types").ScalePoint<Input>
  | import("./types").ScaleBand<Input>
  | import("./types").ScaleTime<
      Date | import("../../../../@types/d3-scale").NumberValue
    >;
/**
 ...
 * the default types.
 */
export declare const computeXYScalesForSeries: <
  S = never,
  D extends SerieDatum = SerieDatum
>(
  series: Serie<S, D>[],
  ...
  xScale:
    ...
    | import("./types").ScaleTime<
        Date | import("../../../../@types/d3-scale").NumberValue
      >
    | import("./types").ScalePoint<D["x"]>
    | import("./types").ScaleBand<D["x"]>;
  yScale:
    | import("./types").ScaleLog
    | import("./types").ScaleSymlog
    | import("./types").ScaleLinear<number>
    | import("./types").ScaleTime<
        Date | import("../../../../@types/d3-scale").NumberValue
      >
    | import("./types").ScalePoint<D["y"]>
    | import("./types").ScaleBand<D["y"]>;
  x: {
    all: unknown[];
    min: unknown;
    max: unknown;
...
export declare const generateSeriesXY: <
  S = never,
  D extends SerieDatum = SerieDatum
>(
 ...
 */
export declare const generateSeriesAxis: <
...
>(
  ...
  scaleSpec: ScaleSpec,
  {
    ...
    getValue?:
      | ((d: { data: Record<Axis, Value | null> }) => Value | null)
      | undefined;
    setValue?:
      | ((
          d: {
...
export declare const stackAxis: <S = never, D extends SerieDatum = SerieDatum>(
  axis: ScaleAxis,
  xy: StackedXY,
  series: NestedSerie<S, D>[]
) => void;
