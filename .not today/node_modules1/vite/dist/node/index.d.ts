...
import {
  TransformOptions as esbuild_TransformOptions,
  TransformResult as esbuild_TransformResult,
  BuildOptions as esbuild_BuildOptions,
} from "../../../esbuild/lib/main.js";
export {
  TransformOptions as EsbuildTransformOptions,
  version as esbuildVersion,
} from "../../../esbuild/lib/main.js";
import * as PostCSS from "../../../postcss/lib/postcss.mjs";
import {
  ViteRuntimeOptions,
  ViteModuleRunner,
  ViteRuntime,
 ...
 */
declare function isFileServingAllowed(
  url: string,
  server: ViteDevServer
): boolean;
 ...
 * @experimental
 */
declare function createViteRuntime(
  server: ViteDevServer,
...
export {
  ...
  type SSRTarget,
  type SendOptions,
  type ServerHMRChannel,
  ServerHMRConnector,
  type ServerHook,
  type ServerOptions,
  SplitVendorChunkCache,
  type SsrDepOptimizationOptions,
  Terser,
  type TerserOptions,
