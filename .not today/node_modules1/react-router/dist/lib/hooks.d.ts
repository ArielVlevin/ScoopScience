...
import { Action as NavigationType } from "../../../@remix-run/router/dist";
import type {
  NavigateOptions,
  RouteContextObject,
  RouteMatch,
 ...
 */
export declare function useResolvedPath(
  to: To,
  {
    relative,
  }?: {
...
export declare function useRoutesImpl(
  routes: RouteObject[],
  locationArg?: Partial<Location> | string,
...
export declare class RenderErrorBoundary extends React.Component<
...
export declare function _renderMatches(
  matches: RouteMatch[] | null,
  parentMatches?: RouteMatch[],
  dataRouterState?: RemixRouter["state"] | null,
  future?: RemixRouter["future"] | null
): React.ReactElement | null;
/**
 ...
 */
export declare function useNavigation(): import("../../../@remix-run/router/dist").Navigation;
/**
