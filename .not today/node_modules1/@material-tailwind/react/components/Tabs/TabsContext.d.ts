...
export declare const setAnimation: (
  dispatch: (arg: object) => void,
  value: animate
) => void;
export declare const setIndicator: (
  dispatch: (arg: object) => void,
  value: indicatorProps
) => void;
export declare const setIsInitial: (
  dispatch: (arg: object) => void,
  value: isInitial
) => void;
export declare const setOrientation: (
  dispatch: (arg: object) => void,
  value: orientation
) => void;
