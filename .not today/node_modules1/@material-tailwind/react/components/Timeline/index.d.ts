...
> & {
  ...
  Icon: React.ForwardRefExoticComponent<
    import("./TimelineIcon").TimelineIconProps &
      React.RefAttributes<HTMLSpanElement>
  >;
  Header: React.ForwardRefExoticComponent<
    import("./TimelineHeader").TimelineHeaderProps &
      React.RefAttributes<HTMLDivElement>
  >;
  Body: React.ForwardRefExoticComponent<
    import("./TimelineBody").TimelineBodyProps &
      React.RefAttributes<HTMLDivElement>
  >;
  Connector: React.ForwardRefExoticComponent<
    import("./TimelineConnector").TimelineConnectorProps &
      React.RefAttributes<HTMLSpanElement>
  >;
};
