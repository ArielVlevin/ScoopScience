...
export declare function createBrowserRouter(
  routes: RouteObject[],
  opts?: DOMRouterOpts
): RemixRouter;
 ...
 */
export declare function HashRouter({
  basename,
  children,
  future,
  window,
 ...
 */
export declare function useLinkClickHandler<
 ...
 * `React.useCallback()`.
 */
export declare function useBeforeUnload(
